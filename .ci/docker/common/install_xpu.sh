...
function install_ubuntu() {
    ...
    # The kernel and xpu-smi packages
    apt-get install -y flex bison xpu-smi # intel-fw-gpu intel-i915-dkms linux-headers-$(uname -r)
...
function install_centos() {
    ...
    dnf config-manager --add-repo \
        ...
        # https://repositories.intel.com/gpu/rhel/8.8/production/2328/unified/intel-gpu-8.8.repo
        # https://repositories.intel.com/gpu/rhel/9.0/production/2328/unified/intel-gpu-9.0.repo
        # https://repositories.intel.com/gpu/rhel/9.2/production/2328/unified/intel-gpu-9.2.repo
...
EOF
    ...
    # The kernel and xpu-smi packages
    dnf install -y flex bison # kernel-headers
    # Compute and Media Runtimes
    dnf install -y \
